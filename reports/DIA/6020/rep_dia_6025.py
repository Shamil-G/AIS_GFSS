...
def format_worksheet(worksheet, common_format):
	...
	worksheet.write(2, 9, 'КЗД', common_format)
	worksheet.write(2, 10, 'МЗП', common_format)
	worksheet.write(2, 11, 'Количество месяцев', common_format)
	worksheet.write(2, 12, 'Назначенный размер', common_format)
	worksheet.write(2, 13, 'Статус', common_format)
